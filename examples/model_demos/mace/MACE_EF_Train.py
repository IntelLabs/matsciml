...
def main(args):
    ...
    dm = MatSciMLDataModule.from_devset(
        "LiPSDataset",dset_kwargs={"transforms":[PointCloudToGraphTransform("pyg", cutoff_dist=args.cutoff)]}
    )
...
if __name__ == "__main__":  
    ...
    parser.add_argument("--num_bessel", type=int, default=8,help="Bessel embeding size")
    parser.add_argument("--num_polynomial_cutoff", type=int, default=5, help="Radial basis polynomial cutoff")
    parser.add_argument("--num_interactions", type=int, default=2, help="No. of interaction layers")
    parser.add_argument("--hidden_irreps", type=str, default='16x0e+16x1o+16x2e', help="Hidden Irrep Shape")
    parser.add_argument("--correlation_order", type=int, default=3, help="Correlation Order")
    parser.add_argument("--MLP_irreps", type=str, default='16x0e', help="Irreps of Non-linear readout block")
